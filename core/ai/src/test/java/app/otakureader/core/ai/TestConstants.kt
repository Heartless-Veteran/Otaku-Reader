 ...
 * They follow the format of real Gemini API keys (AIza prefix) but are
 * explicitly marked as test doubles to avoid false positives from security scanners.
 */
object TestConstants {
    /**
     * Fake API key for testing. NOT a real Gemini API key.
     * Format: TEST_GEMINI_API_KEY_[description]
     */
